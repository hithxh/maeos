...
class UniqueImageReward(GlobalReward):
    ...
    def __init__(
        ...
        This data system should be used with the :class:`~env.sats.ImagingSatellite` and
        a scenario that generates targets, such as :class:`~env.scene.UniformTargets` or
        :class:`~env.scene.CityTargets`.
