...
from env.sim.dyn import LOSCommDynModel
...
class NoCommunication(CommunicationMethod):
    ...
    def __init__(self):
        ...
        will maintain their own :class:`~env.data.DataStore` and not share data with others.
        """
        super().__init__()
...
class LOSCommunication(CommunicationMethod):
    ...
    def __init__(self) -> None:
        ...
        :class:`~env.sim.dyn.LOSCommDynModel`. to use this communication method.
        """
        super().__init__()
