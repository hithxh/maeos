"""``env.comm`` provides methods of communication for multisatellite environments.

Communication methods are used to induce collaborative behavior between satellites.
While the :class:`~env.data.GlobalReward` acts as a global critic for the environment,
...
of satellites should share data. Then, each local :class:`~env.data.DataStore` is
...
from env.comm.communication import (
    CommunicationMethod,
    FreeCommunication,
    LOSCommunication,
