"""Actions ``env.act`` can be used to add actions to an agent.

To configure the observation, set the ``action_spec`` attribute of a :class:`~env.env.scenario.satellites.Satellite`
...
+----------------------------+---------+-------------------------------------------------------------------------------------------------------+
| :class:`DiscreteFSWAction` | 1       | Call an arbitrary ``@action`` decorated function in the :class:`~env.env.simulation.fsw.FSWModel`. |
+----------------------------+---------+-------------------------------------------------------------------------------------------------------+
...
from env.act.actions import Action
from env.act.discrete_actions import (
    Charge,
    Desat,
    DiscreteAction,
    DiscreteFSWAction,
