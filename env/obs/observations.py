...
from env.utils.functional import vectorize_nested_dict
...
class OpportunityProperties(Observation):
        ...
        *target_properties: dict[str, Any],
        ...
        Args:
            ...
            type: The type of opportunity to consider. Can be ``target``, ``ground_station``,
                ...
                :obj:`~env.sats.AccessSatellite.add_location_for_access_checking`.
            name: Name of the observation.
        """
        if name is None:
            name = type
    ...
    def get_obs(self):
        ...
        :meta private:
        """
        from env.sats import AccessSatellite
